...
require_once '../controllers/modifyUsersController.php';
...
<div class="container mycontainer col-10 mt-4">
    ...
    <table class="table shadow p-5">
        ...
        <tbody>
            ...
            <?php foreach ($gestionArray as $client) { ?>
                <tr>
                    ...
                    <td>
                        <form action="infoClient.php" method="post">
                            ...
                            <input type="hidden" name="idClient" value="<?= $client["user_id"] ?>">
                            <button class="btn btn-outline-primary btn-sm">Plus d'info</button>
                        </form>
                    </td>
                    <td>
                        <!-- Button trigger modal -->
                        <button type="button" class="btn btn-outline-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteModal-<?= $client["user_id"] ?>">
                            Supprimer fiche
                        </button>

                        <!-- Modal -->
                        <div class="modal fade" id="deleteModal-<?= $client["user_id"] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <form action="" method="POST">
                                            <input type="hidden" name="idDeleteClient" value="<?= $client["user_id"] ?>">
