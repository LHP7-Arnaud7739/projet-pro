            ...
            <div class="m-4">
                <form class="d-flex justify-content-center pt-5" action="index.php" method="POST">
                    <div class="col-4  mb-3 form-group">
                        <label for="pseudo" class="form-label">Mail / Pseudo: </label><span class="text-danger">

                        </span>
                        <input value="" name="pseudo" type="text" class="mb-4 form-control" id="pseudo">

                        <label for="password" class="form-label">Mot de passe: </label><span class="text-danger">

                        </span>
                        <input value="" name="password" type="text" class="mb-4 form-control" id="password">
                        <div class="d-flex justify-content-center ">
                            <a href="forumValidation.php" type="submit" value="ok" class=" m-2 col-2 btn btn-success ">Valider</a>
                            <a href="forum.php" type="submit" value="ok" class="m-2 col-2 btn btn-danger ">Retour </a>
                        </div>
