...
<body>
    <div class="row d-sm-block sticky-top  ">
        <div class="col navbar border border-dark">
            ...
            <a href="../index.php" class="text-white btn d-flex justify-content-end boutons m-2" type="button" value="Accueil" style="background-color:green;">Accueil</a>
    ...
    <?php } else { ?>
        <div class="row p-4">
            ...
            <form class="d-flex justify-content-center pt-5" action="index.php" method="POST">
                <div class="col-4  mb-3 form-group">
                    ...
                    <input value="<?= isset($_POST["nom"]) ? htmlspecialchars($_POST["nom"]) : "" ?>" name="nom" type="text" class="mb-4 form-control" id="nom" placeholder="Ex : Dupont...">
                    ...
                    <input value="<?= isset($_POST["prenom"]) ? htmlspecialchars($_POST["prenom"]) : "" ?>" name=" prenom" type="text" class="mb-4 form-control" id="prenom" placeholder="Ex : Jean...">
                    ...
                    <input value="<?= isset($_POST["pseudo"]) ? htmlspecialchars($_POST["pseudo"]) : "" ?>" name=" pseudo" type="text" class="mb-4 form-control" id="pseudo" placeholder="Ex : DupontJean897...">
                    ...
                    <input name="mdp" type="password" class="mb-4 form-control" id="mdp">
                    ...
                    <input name="confMdp" type="password" class="mb-4 form-control" id="confMdp">
        ...
        <div class="d-flex justify-content-center">
            <a href="forumValidation.php" type="submit" value="ok" class=" m-2 col-1 btn btn-success ">Inscription</a>

            <a href="forum.php" type="submit" value="ok" class="m-2 col-1 btn btn-danger ">Retour </a>
    ...
    <footer class="border border-secondary">
        <div class="row text-center">
            <div class="p-4 vertical col-4 ">
                ...
                <p> PESQUET Manuella </p>
                <p>98 Route Des Hêtres </p>
                <p>76110 MANNEVILLE LA GOUPIL</p>
                <p>06 52 94 20 39</p>
                <p>09 51 11 09 18</p>
            ...
            <div class="p-4 col-4 ">
                ...
                <div id="carouselExampleIndicators" class="text-center carousel slide mt-5" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item" data-interval="1000">⭐️⭐️⭐️⭐️⭐️ <br> <br>
            ...
            <div class="p-4 vertical1 col-4 ">
                <div>
                    ...
                    <p class="text-center"> lundi: 9H00 - 18H </p>
                    <p class="text-center"> Mardi: 9H00 - 18H </p>
                    <p class="text-center"> Mercredi: 9H00 - 12H </p>
                    <p class="text-center"> Jeudi: 9H00 - 18H </p>
                    <p class="text-center"> Vendredi: 9H00 - 18H </p>
                    <p class="text-center"> Samedi: 9H00 - 12H </p>
