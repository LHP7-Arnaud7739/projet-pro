    ...
    <?php foreach ($arrayCat as $cat) { ?>
        <div class="col">
            <div class="text-center card">
                <img src="../assets/img/<?= $cat["pictureCat"] ?>" class="photoCardCat card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title"><?= $cat["nameCat"] ?></h5>
                    <p class="card-text"><?= $cat["introCat"] ?></p>
                </div>
                <div class="card-body">
                <a class="boutons btn text-white" type="button" style="background-color:green;" href="testTableau2D.php">+ d'info</a>
                </div>
            </div>
        </div>
        <?php } ?>  
