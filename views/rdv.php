...
<div class="row p-4">
            ...
            <form class="d-flex justify-content-center pt-5" action="" method="POST">
                <div class="col-4  mb-3 form-group">
                    <label for="prestations" class="fs-4 form-label mt-3">Prestations : </label><span class="text-danger">
                        
                    </span>
                    <input value="" name="prestations" type="text" class="form-control" id="prestations" placeholder="Ex : Dupont..." required>

                    <label for="date" class="fs-4 form-label mt-3">Date: </label><span class="text-danger">
                       
                    </span>
                    <input value="" name=" date" type="text" class="form-control" id="date" placeholder="Ex : Jean..." required>

                    <label for="heure" class="fs-4 form-label mt-3">Heure: </label><span class="text-danger">
                        
                        
                    </span>
                    <input value="" name="heure" type="tel" class="form-control" id="heure" placeholder="061256XXXX" required>

                    <label for="mail" class="fs-4 form-label mt-3">Adresse mail : </label><span class="text-danger">
                       
                    </span>
                    <input value="" name="mail" type="email" class="form-control" id="mail" placeholder="Ex : Dupont.Jean@gmail.com" required>

                    <label for="password" class="fs-4 form-label mt-3">Mot de passe : </label><span class="text-danger">
                        
                    </span>
                    <input value="" name="password" type="text" class="form-control" id="password" placeholder="Ex :**********" required>

                    <label for="confPassword" class="fs-4 form-label mt-3">Confirmation Mot de passe : </label><span class="text-danger">
                        
                    </span>
                    <input value="" name="confPassword" type="text" class="form-control" id="confPassword" placeholder="Ex :**********" required>
