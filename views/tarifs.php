    ...
    <div class=" corps text-center">
        ...
        <div class="row d-flex justify-content-center ">
            <div class="cardTarif m-5 boutons card">
                <div class="card-body">
                    <img class="d-flex jstify-content-center imgTarif" src="../assets/img/tarifRelexo2.png" alt="">
                </div>
                <div class="p-2">
            ...
            <!-- Modal -->
            <div class="col modal fade" id="tarifsReflexo" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="cardTarif m-5 boutons card">
                <div class="card-body">
                <img class="d-flex jstify-content-center imgTarif" src="../assets/img/tarifHypnose.png" alt="">
            ...
            <div class="cardTarif m-5 boutons card">
                <div class="card-body">
                <img class="d-flex jstify-content-center imgTarif" src="../assets/img/tarifMassage.png" alt="">
            ...
            <div class="cardTarif m-5 boutons card">
                <div class="card-body">
                <img class="d-flex jstify-content-center imgTarif" src="../assets/img/tarifAuri.png" alt="">
                </div>
                <div class="p-2">
            ...
            <!-- Modal -->
            <div class="modal fade" id="tarifsAuriculo" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">TARIFS AURICULOTHERAPIES </h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="row modal-body">
                            <div class="col-6 text-start">Hypnose pour le stress </div>
            ...
            <div class="cardTarif m-5 boutons card">
                <div class="card-body">
                <img class="d-flex jstify-content-center imgTarif" src="../assets/img/tarifBougie.png" alt="">
            ...
            <!-- Modal -->
            <div class="modal fade" id="tarifsBougies" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="tarifsBougies">TARIFS BOUGIES HOPI </h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="row modal-body">
                            <div class="col-6 text-start">Hypnose pour le stress </div>
            ...
            <div class="cardTarif m-5 boutons card">
                <div class="card-body">
                <img class="d-flex jstify-content-center imgTarif" src="../assets/img/tarifCarte.png" alt="">
            ...
            <!-- Modal -->
            <div class="modal fade modalTarifs" id="cartesCadeaux" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
