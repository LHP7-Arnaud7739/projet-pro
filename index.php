    ...
    <div class="corps">
        <div id="contain">
            <div class="row justify-content-center" id="content">
                ...
                <!-- DEBUT REFLEXOLOGIE PLANTAIRE -->
                <div id="carouselExampleIndicators" class="carousel slide carousel-fade  w-25 mt-5" data-bs-ride="carousel">
                    <div class="carousel-indicators" data-interval="4000">
        ...
        <div id="contain">
            <div class="row justify-content-center" id="content">
                ...
                <div id="carouselExampleIndicators" class="carousel slide carousel-fade w-25 mt-5" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="assets/img/hypnose2.jpg" class="photo d-block w-100 " alt="Photo-Carousel-Hypnose1">
                        </div>
                        <div class="carousel-item">
                            <img src="assets/img/hypnose.jpg" class="photo d-block w-100 " alt="Photo-Carousel-Hypnose2">
                        </div>
                        <div class="carousel-item">
                            <img src="assets/img/hypnose_clé.jpeg" class="photo d-block w-100 " alt="Photo-Carousel-Hypnose3">
                        </div>
                    </div>
                    <button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
        ...
        <div id="contain">
            <div class="row justify-content-center" id="content">
                ...
                <div class="col-5 bg-white mt-5 p-3 text-center">
                    ...
                    <div>
                        <p><a href="views/massageBienEtre.php" type="submit" value="ok" class=" p-2 btn btn-success ">Cliquez ici</a></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <footer class="border border-secondary">
        <div class="row text-center">
            <div class="p-4 vertical col-4 ">
                ...
                <p>06 52 94 20 39</p>
                <p>09 51 11 09 18</p>
               <p> <a class="" href="https://www.facebook.com/Bien-%AAtre-des-pieds-%C3%AAte-555492944941100"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
